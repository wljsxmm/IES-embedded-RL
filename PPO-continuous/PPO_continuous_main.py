...
def main(args, number, seed, deterministic, draw):
        ...
        while not done:
            ...
            if total_steps % args.evaluate_freq == 0:
                ...
                if evaluate_num % args.save_freq == 0:
                    np.save('./data_train/PPO_continuous_number_{}_seed_{}.npy'.format(number, seed), np.array(evaluate_rewards))
...
if __name__ == '__main__':
    ...
    main(args, number=1, seed=10, deterministic=False, draw=False)