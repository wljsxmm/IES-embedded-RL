...
class DQN(object):
    ...
    def load_model(self, algorithm, number, seed):
        # self.net = torch.load('./results/{}_number_{}_seed_{}.pkl'.format(algorithm, number, seed))
        self.net.load_state_dict(torch.load('./results/{}_number_{}_seed_{}.pt'.format(algorithm, number, seed)))

    def save_model(self, algorithm, number, seed):
        torch.save(self.net.state_dict(), './results/{}_number_{}_seed_{}.pt'.format(algorithm, number, seed))
