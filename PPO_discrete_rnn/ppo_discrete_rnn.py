...
class PPO_discrete_RNN:
    ...
    def save_model(self, number, seed, total_steps):
        torch.save(self.ac.state_dict(), "./model/PPO_actor_env_number_{}_seed_{}_step_{}k.pth".format(number, seed, int(total_steps / 1000)))

    def load_model(self, number, seed, step):
        self.ac.load_state_dict(torch.load("./model/PPO_actor_env_number_{}_seed_{}_step_{}k.pth".format(number, seed, step)))
